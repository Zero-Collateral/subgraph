...
export class USDCLoanTermsConsensus__termSubmissionsResultInterestRateStruct extends ethereum.Tuple {
  get count(): BigInt {
...
export class USDCLoanTermsConsensus__termSubmissionsResultCollateralRatioStruct extends ethereum.Tuple {
  get count(): BigInt {
    return this[0].toBigInt();
  }
...
export class USDCLoanTermsConsensus__termSubmissionsResultMaxLoanAmountStruct extends ethereum.Tuple {
  get count(): BigInt {
    return this[0].toBigInt();
  }
...
export class USDCLoanTermsConsensus__processRequestInputRequestStruct extends ethereum.Tuple {
  get borrower(): Address {
...
export class USDCLoanTermsConsensus__processRequestInputResponsesStruct extends ethereum.Tuple {
  get signer(): Address {
    return this[0].toAddress();
  }
  ...
  get signature(): USDCLoanTermsConsensus__processRequestInputResponsesSignatureStruct {
    return this[6].toTuple() as USDCLoanTermsConsensus__processRequestInputResponsesSignatureStruct;
  }
}

export class USDCLoanTermsConsensus__processRequestInputResponsesSignatureStruct extends ethereum.Tuple {
...
export class USDCLoanTermsConsensus extends ethereum.SmartContract {
  ...
  try_termSubmissions(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<USDCLoanTermsConsensus__termSubmissionsResult> {
    let result = super.tryCall(
      "termSubmissions",
      "termSubmissions(address,uint256):((uint256,uint256,uint256,uint256),(uint256,uint256,uint256,uint256),(uint256,uint256,uint256,uint256))",
      [
  ...
  try_processRequest(
    request: USDCLoanTermsConsensus__processRequestInputRequestStruct,
    responses: Array<USDCLoanTermsConsensus__processRequestInputResponsesStruct>
  ): ethereum.CallResult<USDCLoanTermsConsensus__processRequestResult> {
    let result = super.tryCall(
      "processRequest",
      "processRequest((address,address,address,uint256,uint256,uint256,uint256),tuple[]):(uint256,uint256,uint256)",
      [
