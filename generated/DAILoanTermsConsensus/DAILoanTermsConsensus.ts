...
export class DAILoanTermsConsensus__termSubmissionsResultInterestRateStruct extends EthereumTuple {
  get count(): BigInt {
...
export class DAILoanTermsConsensus__termSubmissionsResultCollateralRatioStruct extends EthereumTuple {
  get count(): BigInt {
    return this[0].toBigInt();
  }
...
export class DAILoanTermsConsensus__termSubmissionsResultMaxLoanAmountStruct extends EthereumTuple {
  get count(): BigInt {
    return this[0].toBigInt();
  }
...
export class DAILoanTermsConsensus__processRequestInputRequestStruct extends EthereumTuple {
  get borrower(): Address {
...
export class DAILoanTermsConsensus__processRequestInputResponsesStruct extends EthereumTuple {
  get signer(): Address {
    return this[0].toAddress();
  }
...
export class DAILoanTermsConsensus__processRequestInputResponsesSignatureStruct extends EthereumTuple {
...
export class DAILoanTermsConsensus extends SmartContract {
  ...
  try_termSubmissions(
    param0: Address,
    param1: BigInt
  ): CallResult<DAILoanTermsConsensus__termSubmissionsResult> {
  ...
  try_processRequest(
    request: DAILoanTermsConsensus__processRequestInputRequestStruct,
    responses: Array<DAILoanTermsConsensus__processRequestInputResponsesStruct>
  ): CallResult<DAILoanTermsConsensus__processRequestResult> {
