...
export class DAIInterestConsensus__processRequestInputRequestStruct extends ethereum.Tuple {
  get lender(): Address {
...
export class DAIInterestConsensus__processRequestInputResponsesStruct extends ethereum.Tuple {
  get signer(): Address {
    return this[0].toAddress();
  }
  ...
  get signature(): DAIInterestConsensus__processRequestInputResponsesSignatureStruct {
    return this[4].toTuple() as DAIInterestConsensus__processRequestInputResponsesSignatureStruct;
  }
}

export class DAIInterestConsensus__processRequestInputResponsesSignatureStruct extends ethereum.Tuple {
...
export class DAIInterestConsensus extends ethereum.SmartContract {
  ...
  try_interestSubmissions(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<DAIInterestConsensus__interestSubmissionsResult> {
    let result = super.tryCall(
      "interestSubmissions",
      "interestSubmissions(address,uint256):(uint256,uint256,uint256,uint256)",
      [
