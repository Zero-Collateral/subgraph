...
export class TTokenHolderActionsChange extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    ...
    assert(
      id !== null,
      "Cannot save TTokenHolderActionsChange entity without an ID"
    );
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save TTokenHolderActionsChange entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("TTokenHolderActionsChange", id.toString(), this);
  }

  static load(id: string): TTokenHolderActionsChange | null {
    return store.get(
      "TTokenHolderActionsChange",
      id
    ) as TTokenHolderActionsChange | null;
  }
...
export class TTokenTotalValuesStatus extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    ...
    assert(
      id !== null,
      "Cannot save TTokenTotalValuesStatus entity without an ID"
    );
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save TTokenTotalValuesStatus entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("TTokenTotalValuesStatus", id.toString(), this);
  }

  static load(id: string): TTokenTotalValuesStatus | null {
    return store.get(
      "TTokenTotalValuesStatus",
      id
    ) as TTokenTotalValuesStatus | null;
  }
