...
export class DAILoans__loansResultValue0Struct extends EthereumTuple {
  get id(): BigInt {
...
export class DAILoans__loansResultValue0LoanTermsStruct extends EthereumTuple {
  get borrower(): Address {
...
export class DAILoans extends SmartContract {
  ...
  try_loans(loanID: BigInt): CallResult<DAILoans__loansResultValue0Struct> {
